...
String data;
String server = "www.sweetcaffeine.nl";
String uri = "/growbox/getfile.php";//
...
void upddate() {
  ...
  data = "password=growbox&temperature=" + String(t) + "&time=" + String(sendtime) + "&humidity=" + String(h) + "&groundmoisture=" + String(m) + "&day=" + String(duday) + "&month=" + String(dumonth) + "&distance=" + String(distance) + "&fans=" + String(fans);
  Serial.println(data);
  httppost();
